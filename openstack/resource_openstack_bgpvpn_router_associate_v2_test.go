...
func testAccCheckBGPVPNRouterAssociateV2Exists(n string, ra *bgpvpns.RouterAssociation) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		if found.ID != id {
			return fmt.Errorf("BGP VPN router association not found")
		}
