...
func resourceLoadBalancerV2Create(d *schema.ResourceData, meta interface{}) error {
	...
	err = waitForLBV2LoadBalancer(lbClient, lb.ID, "ACTIVE", []string{"PENDING_CREATE", "PENDING_UPDATE"}, timeout)
	if err != nil {
		return err
	}
...
func resourceLoadBalancerV2Update(d *schema.ResourceData, meta interface{}) error {
	...
	if updateOpts != (loadbalancers.UpdateOpts{}) {
		...
		err = waitForLBV2LoadBalancer(lbClient, d.Id(), "ACTIVE", []string{"PENDING_CREATE", "PENDING_UPDATE"}, timeout)
		if err != nil {
			return err
		}
...
func resourceLoadBalancerV2Delete(d *schema.ResourceData, meta interface{}) error {
	...
	err = waitForLBV2LoadBalancer(lbClient, d.Id(), "DELETED", nil, timeout)
	if err != nil {
		return err
	}
