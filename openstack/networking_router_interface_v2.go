...
func resourceNetworkingRouterInterfaceV2StateRefreshFunc(ctx context.Context, networkingClient *gophercloud.ServiceClient, portID string) resource.StateRefreshFunc {
...
func resourceNetworkingRouterInterfaceV2DeleteRefreshFunc(ctx context.Context, networkingClient *gophercloud.ServiceClient, d *schema.ResourceData) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
