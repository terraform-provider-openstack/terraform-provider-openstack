...
func keyManagerContainerV1WaitForContainerDeletion(ctx context.Context, kmClient *gophercloud.ServiceClient, id string) resource.StateRefreshFunc {
...
func keyManagerContainerV1WaitForContainerCreation(ctx context.Context, kmClient *gophercloud.ServiceClient, id string) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
