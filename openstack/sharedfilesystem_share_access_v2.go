...
func sharedFilesystemShareAccessV2StateRefreshFunc(ctx context.Context, client *gophercloud.ServiceClient, shareID string, accessID string) resource.StateRefreshFunc {
...
func sharedFilesystemShareAccessV2StateRefreshStateOld(ctx context.Context, client *gophercloud.ServiceClient, shareID string, accessID string) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
...
func sharedFilesystemShareAccessV2StateRefreshStateNew(ctx context.Context, client *gophercloud.ServiceClient, accessID string) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
