...
func keyManagerOrderV1WaitForOrderDeletion(ctx context.Context, kmClient *gophercloud.ServiceClient, id string) resource.StateRefreshFunc {
...
func keyManagerOrderV1WaitForOrderCreation(ctx context.Context, kmClient *gophercloud.ServiceClient, id string) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
