...
func containerInfraClusterV1StateRefreshFunc(ctx context.Context, client *gophercloud.ServiceClient, clusterID string) resource.StateRefreshFunc {
...
func containerInfraNodeGroupV1StateRefreshFunc(ctx context.Context, client *gophercloud.ServiceClient, clusterID string, nodeGroupID string) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
