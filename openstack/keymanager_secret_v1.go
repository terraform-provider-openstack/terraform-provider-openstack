...
func keyManagerSecretV1WaitForSecretDeletion(ctx context.Context, kmClient *gophercloud.ServiceClient, id string) resource.StateRefreshFunc {
...
func keyManagerSecretV1WaitForSecretCreation(ctx context.Context, kmClient *gophercloud.ServiceClient, id string) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
...
func keyManagerSecretMetadataV1WaitForSecretMetadataCreation(ctx context.Context, kmClient *gophercloud.ServiceClient, id string) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
