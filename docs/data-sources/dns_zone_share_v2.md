...
The `openstack_dns_zone_share_v2` data source retrieves a DNS share for a given
zone. It can be used to discover which projects a zone has been shared with.
