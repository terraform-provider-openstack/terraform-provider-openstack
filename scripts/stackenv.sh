...
_DRAGENT_ID=$(openstack bgp dragent list -c id -f value)
_DRAGENT_HOST=$(openstack bgp dragent list -c host -f value)
...
echo export OS_DRAGENT_ID="$_DRAGENT_ID" >> openrc
echo export OS_DRAGENT_HOST="$_DRAGENT_HOST" >> openrc
